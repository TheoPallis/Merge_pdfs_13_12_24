...
def get_150_folders(path):
    ...
    pb_mapping_dict = None
    # pod_df = pd.read_excel(r"C:\Users\G.Kolokythas\Downloads\Perimeter V2.xlsx", sheet_name= 'POD',dtype=str)
    pod_mapping_dict = None
...
def processor(folder_list_150, pb_mapping_dict,pod_mapping_dict,exodika_mapping_dict,start_index,end_index=10.000):
    output_base_path = r"C:\Users\G.Kolokythas\Desktop\Downloaded dei\150 batches files\Final3"
